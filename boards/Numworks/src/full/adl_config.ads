...
package ADL_Config is
   ...
   Runtime_Name                   : constant String  := "ravenscar-full-numworks"; -- From default value
   ...
   Board                          : constant String  := "Numworks";          -- From command line
   ...
   Runtime_Name_Suffix            : constant String  := "numworks";          -- From board definition
